sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("pt/com/pm/crudUI5-manageProducts/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#CRUDProductsManagement-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#CRUDProductsManagement-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("pt.com.pm.crudUI5-manageProducts.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["pt/com/pm/crudUI5-manageProducts/localService/mockserver"], function (mockserver) {
